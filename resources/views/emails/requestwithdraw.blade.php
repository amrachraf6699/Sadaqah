...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto p-6 bg-white shadow-lg rounded-lg mt-6">
        <h1 class="text-4xl text-center font-bold mb-4">Your withdrawal request has been submitted successfully</h1>

        <hr class="my-6 border-gray-300">

        <div class="p-6 border border-gray-200 rounded-lg text-center">
            <h2 class="text-lg mb-4 font-extrabold text-center">Your withdrawal request of amount {{ $data['amount']  }} to {{ $data['identifier'] }} has been submitted successfully. You will receive the amount in your account within 3-5 business days.</h2>
        </div>
