...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="container mx-auto p-6 bg-white shadow-lg rounded-lg mt-6">
        <h1 class="text-4xl text-center font-bold mb-4">Thanks for donation for {{ $campaign->title }}</h1>

        <hr class="my-6 border-gray-300">

        <div class="p-6 border border-gray-200 rounded-lg text-center">
            <h2 class="text-2xl mb-4 font-extrabold underline">Campaign Details</h2>
            <div class="text-center">
                <p class="text-lg font-semibold mb-2">{{ $campaign->title }}</p>
                <p class="text-gray-600 mb-2">{{ $campaign->user->name }} ({{ $campaign->user->email }})</p>
